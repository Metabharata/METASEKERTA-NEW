...
public class BabEmpatManager : MonoBehaviour
{
    string ManajemenBab = "BabEmpat";
    ...
    {
        babSatuSelesai = true;
        PlayerPrefs.SetString("BabEmpatSelesaiMeta", ManajemenBab);
